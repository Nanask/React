...
export const JoinForm = () => {
  ...
  return (
    <div className="join_form">
      <input onChange={onChangeAccount} name="userid" value={user.userid} type="text" placeholder="아이디를 입력해주세요" />
      <input onChange={onChangeAccount} name="password" type="jpassword" value={user.password} placeholder="비밀번호를 입력해주세요" />
      <input onChange={onChangeAccount} name="re_password" type="password" value={user.re_password} placeholder="비밀번호를 한번 더 입력해주세요" />
      <input onChange={onChangeAccount} name="email" type="email" value={user.email} placeholder="E_mail을 입력해주세요" />
